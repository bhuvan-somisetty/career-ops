              ...
              <>
                ...
                >
                  <Link href="/profile" onClick={() => setProfileMenuOpen(false)}>
                    <div className="w-full text-left px-3 py-2 hover:bg-zinc-900/60 hover:text-zinc-250 transition-colors flex items-center gap-2 cursor-pointer">
                  ...
                  <button 
                    ...
                    className="w-full text-left px-3 py-2 hover:bg-red-500/10 hover:text-red-450 transition-colors flex items-center gap-2 cursor-pointer"
                  >
            ...
            >
              ...
              <div className="border-t border-zinc-900 pt-4 flex items-center justify-between gap-3">
                ...
                <button
                  ...
                  className="p-2 rounded-lg border border-zinc-900 text-zinc-500 hover:text-red-400 hover:bg-red-500/5 cursor-pointer shrink-0"
                  title="Log Out"
                >
