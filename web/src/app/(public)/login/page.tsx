...
import { LogIn, Loader2, AlertTriangle, ArrowRight } from 'lucide-react';
    ...
    <div className="flex-1 w-full min-h-[80vh] flex items-center justify-center p-6">
      ...
      >
        <div className="space-y-1.5 text-center">
          ...
          <h1 className="text-lg font-bold text-zinc-100">Welcome back</h1>
          <p className="text-xs text-zinc-500">Sign in to your Career Ops workspace</p>
        </div>
