    ...
    <div className="min-h-screen flex flex-col w-full bg-[#050507] text-zinc-100 overflow-x-hidden relative">
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2.5 group">
            ...
            <div>
              ...
              <span className="text-[8px] text-zinc-500 font-mono block">Career Operating OS</span>
            </div>
          </Link>
      ...
      <footer className="w-full border-t border-zinc-900/60 bg-[#050507] py-8 px-6 text-[10px] text-zinc-650 font-mono">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          <p>© 2026 Career Officer Inc. All placement intelligence operations are running locally.</p>
